...
import { Role } from '../backend-nest/src/roles/entities/role.entity';
import { User } from '../backend-nest/src/users/entities/user.entity';
import { MasterCatalog } from '../backend-nest/src/catalogs/entities/master-catalog.entity';
import { MasterCatalogItem } from '../backend-nest/src/catalogs/entities/master-catalog-item.entity';
import { Store } from '../backend-nest/src/stores/entities/store.entity';
import { Service } from '../backend-nest/src/services/entities/service.entity';
...
async function seed() {
  const dataSource = new DataSource({
    ...
    entities: [Role, User, MasterCatalog, MasterCatalogItem, Store, Service],
    synchronize: true,
  });
